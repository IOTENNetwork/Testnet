  ...
  public static final List<EnodeURL> SEPOLIA_BOOTSTRAP_NODES =
      Collections.unmodifiableList(
          Stream.of(
              ...
              .map(EnodeURLImpl::fromString)
              .collect(toList()));
  public static final List<EnodeURL> IOTENTEST_BOOTSTRAP_NODES =
      Collections.unmodifiableList(
          Stream.of(
                  "enode://3cbdb76991bf90dfd3cc0c8ab7c05d2006bc4e718371b93e4a56f70cc889de45fd13489137675b668bd3b2456b6324af03356a47d55a823bd43a12e861b84967@13.56.95.118:30303")
              .map(EnodeURLImpl::fromString)
              .collect(toList()));
